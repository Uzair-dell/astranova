...
int main() {
    ...
    idx = binop138;
    tokens[(int)idx] = type;
    double binop139 = idx + 1.0000000000;
    tokens[(int)binop139] = start;
    double binop140 = idx + 2.0000000000;
    tokens[(int)binop140] = end;
    pos = end;
    double cases141;
    double charat142 = (double)(unsigned char)"\let x = 12 + 34 * 2"[(int)pos];
    double binop143 = charat142 == 32.0000000000;
    if (binop143) {
        cases141 = 1.0000000000;
    } else if (1.0000000000) {
        cases141 = 0.0000000000;
    } else { cases141 = 0.0; }
    double binop144 = pos + cases141;
    pos = binop144;
        sum1 += 0.0000000000;
    }
    dummy = sum1;
    double arr145 = tokens[(int)0.0000000000];
    printf("%f\n", arr145);
    double arr146 = tokens[(int)1.0000000000];
    printf("%f\n", arr146);
    double arr147 = tokens[(int)2.0000000000];
    printf("%f\n", arr147);
    double arr148 = tokens[(int)3.0000000000];
    printf("%f\n", arr148);
    double arr149 = tokens[(int)4.0000000000];
    printf("%f\n", arr149);
    double arr150 = tokens[(int)5.0000000000];
    printf("%f\n", arr150);
    double arr151 = tokens[(int)6.0000000000];
    printf("%f\n", arr151);
    double arr152 = tokens[(int)7.0000000000];
    printf("%f\n", arr152);
    double arr153 = tokens[(int)8.0000000000];
    printf("%f\n", arr153);
    printf("result = %f\n", sum1);
    return 0;
}
